...
//                                         <svg className="w-12 h-12 text-[#88C7B3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                                             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
//                                             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
//                                         </svg>
//                                     </div>
//                                     <p className="text-[#0F172A] opacity-70 mb-6 font-medium">No delivery addresses found</p>
//                                     <button
//                                         onClick={handleAddNewAddress}
...
//                                             className={`border-2 rounded-xl p-5 cursor-pointer transition-all duration-300 ${selectedAddressId === addr._id
...
//                                                     {addr.address_line && (
//                                                         <p className="text-[#0F172A] opacity-80 leading-relaxed">{addr.address_line}</p>
//                                                     )}
//                                                     <p className="font-bold text-[#0F172A] mt-2 text-lg">
//                                                         {addr.city}, {addr.state}
//                                                     </p>
//                                                     {addr.country && (
//                                                         <p className="text-[#0F172A] opacity-70 mt-1">{addr.country}</p>
//                                                     )}
//                                                     {addr.pincode && (
...
//                                             </p>
//                                             <p className="text-[#1D9C7A] font-bold mt-2 text-lg">
...
//                             <h2 className="text-2xl font-bold mb-6 text-[#0F172A]">Order Summary</h2>
...
//                                             </svg>
//                                         </div>
//                                         <span className="font-medium">Safe & encrypted payment</span>
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
