...
//               fabrics, clean cuts, and attention to detail, making NextGen Men
...
//               >
//                 {/* <div className="h-12 w-12 mx-auto mb-4 bg-gray-900 rounded-full" /> */}
//                 <div className="w-40 mb-10 mx-auto">
...
//         </p>
//         <button className="px-10 py-3 rounded-full bg-white text-gray-900 font-semibold hover:bg-gray-200 transition">
//           Shop Now
//         </button>
//       </section>
//     </div>
...
export default function AboutPage() {
  return (
    ...
    //     {/* Gradient Overlay */}
    //     <div className="absolute inset-0 bg-gradient-to-r from-[#7b7cff]/70 via-[#b695ff]/70 to-[#f3b3ff]/70" />
    ...
    //         transition={{ duration: 0.6 }}
    //       >
    //         <h2 className="text-3xl font-bold mb-4 text-[#1F3A93]">
    //           Our Story
    //         </h2>
    //         <p className="text-gray-600 leading-relaxed mb-4">
    //           NextGen Men was born from a simple idea — modern men deserve clothing
    ...
    //   {/* Brand Values */}
    //   <section className="py-20 bg-[#FBEFEF]">
    //     <div className="max-w-6xl mx-auto px-6">
    //       <h2 className="text-3xl font-bold text-center mb-12 text-[#1F3A93]">
    //         What We Stand For
    //       </h2>
    ...
    //   {/* CTA */}
    //   <section className="py-16 bg-gradient-to-r from-[#7b7cff] via-[#b695ff] to-[#f3b3ff] text-white text-center">
    //     <h2 className="text-3xl font-bold mb-4">
    //       Dress Smart. Think NextGen.
    //     </h2>
    ...
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#1D9C7A]/70 via-[#88C7B3]/70 to-[#BEDCD0]/70" />
