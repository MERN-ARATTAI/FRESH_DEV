...
const Product = ({ pageMode = false }) => {
  ...
  //                 <div className="h-48 mb-4 bg-gradient-to-br from-[#F3F1EC] to-[#E4E3E7] rounded-xl" />
  ...
  //               >
  //                 <div className="relative h-48 mb-4 bg-gradient-to-br from-[#F3F1EC] to-[#E4E3E7] rounded-xl flex items-center justify-center overflow-hidden">
  //                   {p.discount ? (
